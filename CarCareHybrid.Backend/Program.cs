...
using CarCareHybrid.Backend.Data;
using CarCareHybrid.Shared.Models;
using CarCareHybrid.Shared.Sync;
...
builder.Services.AddDbContext<CarCareDbContext>(options =>
    options.UseNpgsql(builder.Configuration.GetConnectionString("CarCareDb")));
...
app.MapGet("/api/store", async (CarCareDbContext db) =>
{
    return Results.Ok(await BuildStoreAsync(db));
});

app.MapPost("/api/sync", async (SyncRequest request, CarCareDbContext db) =>
{
...
static async Task<CarCareStore> BuildStoreAsync(CarCareDbContext db)
{
    return new CarCareStore
    {
...
static async Task ReplaceStoreFromFallbackAsync(CarCareStore fallback, CarCareDbContext db)
{
...
static Task ApplyOperationAsync(SyncOperation operation, CarCareDbContext db, JsonSerializerOptions serializerOptions)
{
...
static async Task UpsertVehicleAsync(string payloadJson, CarCareDbContext db, JsonSerializerOptions serializerOptions)
{
...
static async Task UpsertMaintenanceAsync(string payloadJson, CarCareDbContext db, JsonSerializerOptions serializerOptions)
{
...
static async Task UpsertFuelAsync(string payloadJson, CarCareDbContext db, JsonSerializerOptions serializerOptions)
{
...
static async Task UpsertReminderAsync(string payloadJson, CarCareDbContext db, JsonSerializerOptions serializerOptions)
{
...
static async Task UpsertTireAsync(string payloadJson, CarCareDbContext db, JsonSerializerOptions serializerOptions)
{
...
static async Task DeleteVehicleAsync(Guid id, CarCareDbContext db)
{
...
static async Task DeleteMaintenanceAsync(Guid id, CarCareDbContext db)
{
...
static async Task DeleteFuelAsync(Guid id, CarCareDbContext db)
{
...
static async Task DeleteReminderAsync(Guid id, CarCareDbContext db)
{
...
static async Task DeleteTireAsync(Guid id, CarCareDbContext db)
{
